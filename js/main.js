...
//Create out 'main' staet that wll contain the game 
//This is the body of the game itself. It contains all relevant code

var mainState = {
  
  preload: function () {
    //This function will exacture at the begining of the game
    //Here we'll load all of our assests (art, music, etc)
    
},
  
  create: function () {
    //The create funciton is called right after the preload f(x)
